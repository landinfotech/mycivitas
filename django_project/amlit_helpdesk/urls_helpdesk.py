...
from amlit_helpdesk.views.attachment.delete import attachment_delete

from amlit_helpdesk.views.follow_up.delete import followup_delete
from amlit_helpdesk.views.follow_up.edit import followup_edit

from amlit_helpdesk.views.ticket.delete import delete_ticket
from amlit_helpdesk.views.ticket.update import update_ticket
from amlit_helpdesk.views.ticket.view import view_ticket
from amlit_helpdesk.views.ticket.list import (
    ticket_list, datatables_ticket_list, timeline_ticket_list
)
from amlit_helpdesk.views.ticket.report import report_index, run_report

try:
    # TODO: LIT
    #   why is it imported? due to some side-effect or by mistake?
...
urlpatterns = [
    ...
    url(r'^tickets/(?P<ticket_id>[0-9]+)/followup/(?P<followup_id>[0-9]+)/attachment_delete/(?P<attachment_id>[0-9]+)/$',
        attachment_delete,
        name='attachment_del'),
