...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('civitas', '0003_vector_tile_update'),
    ]
    ...
    sql = """
            ...
            SELECT feature_base.id AS id,
                ...
                (
					CASE
						WHEN feature_base.pof IS NOT NULL THEN
							feature_base.pof
						ELSE
							0
						END
                ...
                (
					CASE
						WHEN feature_base.cof IS NOT NULL THEN
							feature_base.cof
						ELSE
							0
						END
                ...
                (
					CASE 
						WHEN risk_lookup.risk_level IS NOT NULL THEN
							TRIM(risk_lookup.risk_level)
						ELSE
							'Unknown'
						END
				) as risk,
                ...
                LEFT JOIN risk_lookup ON feature_base.pof = risk_lookup.pof_value AND feature_base.cof = risk_lookup.cof_value
                LEFT JOIN (
